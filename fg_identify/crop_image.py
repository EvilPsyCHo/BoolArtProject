...
def crop_test(model):
    source_path = Path("./download/test/found/found/")
    body_path = Path("./download/test_body/found/found")
    head_path = Path("./download/test_head/found/found")
    ...
    source_path = Path("./download/test/found/synthetic_lost")
    body_path = Path("./download/test_body/found/synthetic_lost")
    head_path = Path("./download/test_head/found/synthetic_lost")
    ...
    source_path = Path("./download/test/lost/lost")
    body_path = Path("./download/test_body/lost/lost")
    head_path = Path("./download/test_head/lost/lost")
    ...
    source_path = Path("./download/test/lost/synthetic_found")
    body_path = Path("./download/test_body/lost/synthetic_found")
    head_path = Path("./download/test_head/lost/synthetic_found")
